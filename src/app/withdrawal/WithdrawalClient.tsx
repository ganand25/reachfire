...
const STRATEGIES = [
  {
    ...
    label: '4% Rule',
    rate: 0.04,
    description: 'Fixed 4% of initial portfolio, inflation-adjusted annually',
  },
  {
    id: 'three_five',
    label: '3.5% Conservative',
    rate: 0.035,
    description: 'More conservative for 40+ year retirements',
  },
  {
    id: 'guardrails',
    label: 'Guardrails (4.5%)',
    rate: 0.045,
    description: 'Higher base rate with spending guardrails',
  },
];
...
export function WithdrawalClient(): React.JSX.Element {
  ...
  const setAnnualSpending = (v: number): void =>
    setInputs((prev) => ({ ...prev, annualSpending: v }));
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="col-span-2 sm:col-span-1 rounded-xl border border-border bg-card p-4 flex flex-col items-center justify-center py-6">
                ...
                <div className="text-xs text-muted-foreground/60">
                  across {duration}-yr periods since 1926
                </div>
              </div>
              <StatCard
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              <h2 className="font-semibold text-sm mb-4">
                Portfolio Balance Over {duration} Years
              </h2>
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <p className="text-xs text-muted-foreground mt-4">
                The classic Trinity Study (1998) found the 4% rule succeeded ~96% of the time over
                30-year periods. Extending to 40+ years or using a higher withdrawal rate
                significantly reduces success probability.
              </p>
            </div>
          </div>
        </div>
