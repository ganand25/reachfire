...
export function SavingsRateClient(): React.JSX.Element {
  ...
  const setCurrentSavingsRate = (v: number): void =>
    setInputs((prev) => ({ ...prev, currentSavingsRate: v }));
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl">
            The single most powerful lever in FIRE planning. Drag the slider to see how your savings
            rate determines your FIRE timeline.
          </p>
          <ExportBar
        ...
        <div className="rounded-xl border border-ember bg-card p-6 glow-ember-sm mb-6 text-center">
          ...
          <p className="text-muted-foreground">
            At a <strong className="text-foreground">{currentSavingsRate}% savings rate</strong>,
            you reach FIRE in {currentYears >= 60 ? 'more than 60' : currentYears.toFixed(1)} years
          </p>
          {yearsSaved > 0 && (
            ...
            <LineChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 10 }}>
              ...
              <Tooltip
                formatter={(v: number | undefined) =>
                  v !== undefined ? [v.toFixed(1) + ' years', 'Years to FIRE'] : ''
                }
                contentStyle={{
