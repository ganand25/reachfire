...
const WITHDRAWAL_STRATEGIES = [
  ...
  {
    value: 'three_five_percent',
    label: '3.5% Conservative',
    description: 'Safer for long retirements',
  },
  {
                      ...
                      <div className="space-y-1.5">
                        {WITHDRAWAL_STRATEGIES.map((strategy) => {
                          const isSelected =
                            ...
                            (strategy.value === 'three_five_percent' &&
                              inputs.withdrawalRate === 0.035);
                          return (
                            <button
                              key={strategy.value}
              ...
              <div className="rounded-xl border border-border bg-card p-5">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      Nominal growth at {(inputs.expectedReturnRate * 100).toFixed(1)}% return
                    </p>
                  </div>
                  <button
