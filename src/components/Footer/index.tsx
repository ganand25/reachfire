        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Free FIRE calculator with geoarbitrage, Roth ladder planning, and AI insights. Your
          ...
          <div>
            ...
            <div className="mt-6 p-3 rounded-lg bg-card border border-border">
              <p className="text-xs text-muted-foreground">
                <span className="text-foreground font-medium">100% Private.</span> All calculations
                run entirely in your browser using JavaScript. No account required. No data stored.
                No tracking.
              </p>
            </div>
          </div>
